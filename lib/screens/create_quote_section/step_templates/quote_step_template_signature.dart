...
// =============================================================================
// _QuoteSignatureSection — three selectable modes plus a fourth
// deselected state, mirroring Invoice's _SignatureSection
// (step_templates_signature.dart) exactly:
...
//
// Wired to QuoteTemplate's signatureMode/signatureName/signatureImagePath
// — NOT yet synced onto QuoteData at template-select time, and QuoteData
// itself has no matching signature fields yet either (see
// quote_step_template.dart's file header for the pending sync step —
// this is model+UI plumbing only for now, same boundary Invoice's own
// Payment Info / Terms / Signature sections started from before their
// sync step was added).
//
...
// used elsewhere (quote_logos/ etc). Requires image_picker and
// path_provider — both already used elsewhere in this app.
//
// Named distinctly from Invoice's _SignatureSection so both part-file
// libraries can coexist in the app without symbol collisions.
// =============================================================================

class _QuoteSignatureSection extends StatefulWidget {
  ...
  @override
  State<_QuoteSignatureSection> createState() => _QuoteSignatureSectionState();
}

class _QuoteSignatureSectionState extends State<_QuoteSignatureSection> {
  bool _picking = false;
      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            _modeChip(
                context, 'blank', 'Blank Line', Icons.horizontal_rule_rounded),
          ],
        ),
        ...
        if (widget.mode == 'image') ...[
          ...
          Text(
            'Rendered in a script-style font on the quote.',
            style: TextStyle(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 6),
                Text('No signature — nothing will appear on the quote',
