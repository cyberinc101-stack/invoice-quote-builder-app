...
//
// MERGE PASS (this update): imports redirected off the deleted
// executive_receipt_logic_data.dart / executive_receipt_stationary_
// layout.dart files. ExecutiveReceiptPreview now comes from
// executive_template.dart, kPageW now comes from shared_doc_widgets.dart.
// No other change — same widget tree, same behavior.
//
// THERMAL PREVIEW BUG FIX PASS (earlier): same bug as the Review
...
// MERGE PASS: ExecutiveReceiptPreview now comes from the merged
