// lib/screens/create_receipt_section/receipt_edit_widgets.dart
//
// HINT PARAMETER PASS (this update): ReceiptField gained an optional
// `hint` param, wired straight to InputDecoration.hintText. Several
// callsites under step_templates/ (receipt_step_template.dart,
// receipt_step_template_payment.dart, receipt_step_template_terms.dart,
// receipt_step_template_signature.dart) were already passing
// `hint: 'e.g. ...'` — a parameter this widget never actually had —
// which only surfaced as a build error once those files started
// compiling as part of the create-flow folder-parity pass. Added here
// rather than touching every callsite: purely additive, defaults to
// null (no visible change) everywhere it isn't passed.
//
// ACCENT COLOR GRID PASS (earlier): ReceiptColorPicker no longer uses
...
class ReceiptField extends StatelessWidget {
  ...
  /// HINT PARAMETER PASS: optional placeholder text shown inside the
  /// field when empty, wired to InputDecoration.hintText. Several
  /// step_templates/ callsites (e.g. 'e.g. Acme Solutions Ltd') expect
  /// this; previously absent, causing a build error once those files
  /// were included in the create-flow folder-parity restructure.
  final String? hint;
