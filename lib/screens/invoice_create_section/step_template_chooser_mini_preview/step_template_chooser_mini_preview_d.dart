// step_template_chooser_mini_preview_d.dart
// lib/screens/cv_edit_section/step_template_chooser_mini_preview/step_template_chooser_mini_preview_d.dart
//
// Step-chooser dedicated previews – Templates 13–16
...
class StepMiniPreview13Wina extends StatelessWidget {
  const StepMiniPreview13Wina({super.key});
...
class StepMiniPreview14Rio extends StatelessWidget {
  const StepMiniPreview14Rio({super.key});
...
class StepMiniPreview15Summer extends StatelessWidget {
  const StepMiniPreview15Summer({super.key});
...
class StepMiniPreview16Helene extends StatelessWidget {
  const StepMiniPreview16Helene({super.key});
