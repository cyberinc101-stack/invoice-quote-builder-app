// step_template_chooser_mini_preview_b.dart
// lib/screens/cv_edit_section/step_template_chooser_mini_preview/step_template_chooser_mini_preview_b.dart
//
// Step-chooser dedicated previews – Templates 5–8
//   T05 – Luxury              (StepMiniPreview05Luxury)
//   T06 – Gradient Modern     (StepMiniPreview06Gradient)
//   T07 – Editorial           (StepMiniPreview07Editorial)
//   T08 – Pastel Soft         (StepMiniPreview08Pastel)
...
// T05 – Luxury
class StepMiniPreview05Luxury extends StatelessWidget {
  const StepMiniPreview05Luxury({super.key});
      ...
      child: ClipRect(
        child: SizedBox(width: 260, height: 340,
          child: Container(color: _black, child: Column(children: [
            ...
            Container(color: _charcoal, padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
              child: Column(children: [
                Container(width: 44, height: 44,
                  decoration: BoxDecoration(shape: BoxShape.circle,
                      border: Border.all(color: _gold, width: 1.5), color: _black),
                  child: const Center(child: Text('AC', style: TextStyle(
                      fontSize: 11, fontWeight: FontWeight.w300, color: Color(0xFFBFA46A), letterSpacing: 2)))),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const Text('SENIOR PRODUCT DESIGNER', style: TextStyle(
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const Text('   ·   ', style: TextStyle(color: _gold, fontSize: 6)),
                  const Text('+1 555 234 5678', style: TextStyle(fontSize: 5, color: _muted)),
                ]),
              ])),
            ...
            Expanded(child: Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(flex: 6, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _goldSection('EXECUTIVE SUMMARY'), const SizedBox(height: 4),
                  _textLine(150, _muted.withOpacity(0.5)), const SizedBox(height: 2),
                  _textLine(130, _muted.withOpacity(0.45)), const SizedBox(height: 7),
                  _goldSection('PROFESSIONAL EXPERIENCE'), const SizedBox(height: 4),
                  ...[('Sr. Product Designer', 'Stripe', '2021–Present'),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      _textLine(145, _muted.withOpacity(0.35)),
                    ]),
                  )),
                  _goldSection('EDUCATION'), const SizedBox(height: 4),
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 4), child: Row(
                      ...
                      Container(width: 22, height: 22,
                        ...
                        child: Center(child: Text(e.$3, style: const TextStyle(
                            fontSize: 6, color: _gold, fontWeight: FontWeight.w600)))),
                      const SizedBox(width: 6),
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(e.$1, style: const TextStyle(fontSize: 6, fontWeight: FontWeight.w600, color: _cream)),
  ...
  // FIXED: Text wrapped in Expanded so it can't overflow the narrow right column
  Widget _goldSection(String t) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Row(children: [
      _bar(8, 0.5, _gold), const SizedBox(width: 4),
...
// T06 – Gradient Modern
class StepMiniPreview06Gradient extends StatelessWidget {
  const StepMiniPreview06Gradient({super.key});
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 2.5),
                    ...
                    child: const Text('Senior Product Designer',
                        style: TextStyle(fontSize: 5.5, color: Colors.white, fontWeight: FontWeight.w500))),
                  const SizedBox(height: 5),
                  Row(children: [
                ...
                Expanded(flex: 6, child: Column(children: [
                  _card('Professional Summary', Icons.person_outline_rounded,
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      _textLine(150, _muted.withOpacity(0.4)),
                    ])),
                  const SizedBox(height: 5),
  ...
  Widget _card(String title, IconData icon, Widget child) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(margin: const EdgeInsets.symmetric(vertical: 3), height: 1,
          decoration: const BoxDecoration(gradient: LinearGradient(
...
// T07 – Editorial
class StepMiniPreview07Editorial extends StatelessWidget {
  const StepMiniPreview07Editorial({super.key});
      ...
      child: ClipRect(
        child: SizedBox(width: 260, height: 340,
          child: Container(color: _paper, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(14, 8, 14, 0), child:
              Row(crossAxisAlignment: CrossAxisAlignment.end,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('ALEXANDRA', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w900,
                      color: _ink, height: 0.9, letterSpacing: -0.5)),
                  const Text('CHEN', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w900,
                      color: _ink, height: 0.9, letterSpacing: -0.5)),
                  const SizedBox(height: 4),
                  Row(children: [
                    _bar(12, 2, _red), const SizedBox(width: 5),
                    const Text('SR. PRODUCT DESIGNER', style: TextStyle(
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  const Text('alex.chen@email.com', style: TextStyle(fontSize: 5, color: _muted)),
                  const Text('+1 555 234 5678',     style: TextStyle(fontSize: 5, color: _muted)),
                  const Text('San Francisco, CA',   style: TextStyle(fontSize: 5, color: _muted)),
                ]),
              ])),
            Padding(padding: const EdgeInsets.fromLTRB(14, 5, 14, 0), child: Column(children: [
              _bar(double.infinity, 1.5, _ink, r: 0), const SizedBox(height: 2),
              _bar(double.infinity, 0.3, _ink, r: 0),
            ])),
            Expanded(child: Padding(padding: const EdgeInsets.fromLTRB(14, 7, 14, 8),
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                SizedBox(width: 72, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  _textLine(60, _muted.withOpacity(0.4)), const SizedBox(height: 7),
                  ...
                  ...[('Sr. Product Designer', 'Stripe', '2021–Present'),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(e.$1, style: const TextStyle(fontSize: 7, fontWeight: FontWeight.w800,
                      ...
                      Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        const Text('—  ', style: TextStyle(color: _red, fontSize: 7, fontWeight: FontWeight.w700)),
...
// T08 – Pastel Soft
class StepMiniPreview08Pastel extends StatelessWidget {
  const StepMiniPreview08Pastel({super.key});
        ...
        child: SizedBox(width: 260, height: 340,
          child: Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            Container(width: 80, color: _lavender,
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                Container(width: 42, height: 42,
                  ...
                  child: const Icon(Icons.person_rounded, color: _lavD, size: 20)),
                const SizedBox(height: 5),
                const Text('Alexandra Chen', textAlign: TextAlign.center, style: TextStyle(
                ...
                Container(padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 2),
                  ...
                  child: const Text('Product Designer', textAlign: TextAlign.center, style: TextStyle(
                      fontSize: 4.5, color: _lavD, fontWeight: FontWeight.w600))),
                const SizedBox(height: 7),
                _sideS('CONTACT'), const SizedBox(height: 4),
                ...[
                ...
                ].map((c) => Padding(padding: const EdgeInsets.only(bottom: 3.5),
                  child: Row(children: [
                    Container(width: 14, height: 14,
                      decoration: BoxDecoration(color: _lavD.withOpacity(0.12), borderRadius: BorderRadius.circular(4)),
                      child: Icon(c.$1, size: 7, color: _lavD)),
                    const SizedBox(width: 4),
                    Expanded(child: Text(c.$2, style: const TextStyle(fontSize: 4.5, color: _muted),
                        overflow: TextOverflow.ellipsis)),
                  ]))),
                const SizedBox(height: 6),
                _sideS('SKILLS'), const SizedBox(height: 4),
                ...
                const SizedBox(height: 6),
                _sideS('LANGUAGES'), const SizedBox(height: 3),
            ...
            Expanded(child: Container(color: const Color(0xFFFAFAFC),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                _mainS('About Me', _peach), const SizedBox(height: 4),
                ...
                const SizedBox(height: 6),
                _mainS('Experience', _lavD), const SizedBox(height: 4),
                ...[('Sr. Product Designer', 'Stripe', '2021–Now'),
                  ...
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8),
                      boxShadow: [BoxShadow(color: _lavD.withOpacity(0.07), blurRadius: 6, offset: const Offset(0, 2))]),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    // FIXED
                    Row(children: [
                    ...
                    Text(e.$2, style: const TextStyle(fontSize: 5.5, color: _peach, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 2),
                    _textLine(double.infinity, _muted.withOpacity(0.35)),
                  ]),
                )),
                _mainS('Education', _lavD), const SizedBox(height: 4),
                ...[('BFA Graphic Design', 'RISD', '2016'), ('Certificate – HCI', 'Stanford', '2019')].map((e) =>
                  Container(margin: const EdgeInsets.only(bottom: 4), padding: const EdgeInsets.all(6),
                    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8),
                        boxShadow: [BoxShadow(color: _lavD.withOpacity(0.06), blurRadius: 6, offset: const Offset(0, 2))]),
                    child: Row(children: [
                      Container(width: 24, height: 24,
                        decoration: BoxDecoration(color: _lavender, borderRadius: BorderRadius.circular(6)),
