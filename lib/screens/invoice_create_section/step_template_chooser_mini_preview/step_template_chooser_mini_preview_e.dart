...
// lib/screens/cv_edit_section/step_template_chooser_mini_preview/step_template_chooser_mini_preview_e.dart
//
...
class MiniPreview17Canfield extends StatelessWidget {
              ...
              child: Row(children: [
                for (final t in ['alex.chen@email.com', '+1 555 234 5678', 'San Francisco'])
                  Expanded(child: Row(children: [
                    ...
                    Expanded(child: Text(t, style: const TextStyle(fontSize: 4.5, color: Colors.white54), overflow: TextOverflow.ellipsis)),
                  ])),
              ])),
                ...
                Expanded(flex: 7, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  for (final e in <(String, String, String)>[
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 7), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Expanded(child: Text(e.$1, style: const TextStyle(fontSize: 6.5, fontWeight: FontWeight.w900, color: _black), overflow: TextOverflow.ellipsis)),
                        Container(padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 1.5),
                          color: _black,
                          child: Text(e.$3, style: const TextStyle(color: Colors.white, fontSize: 4.5, fontWeight: FontWeight.w700))),
                      ]),
                      Text(e.$2, style: const TextStyle(fontSize: 5.5, color: _muted, fontStyle: FontStyle.italic)),
                      const SizedBox(height: 2),
                      _textLine(double.infinity, _muted.withOpacity(0.35)), const SizedBox(height: 1.5),
                  ...
                  for (final e in <(String, String, String)>[
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 5), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(e.$1, style: const TextStyle(fontSize: 6, fontWeight: FontWeight.w900, color: _black), overflow: TextOverflow.ellipsis),
                        Text(e.$2, style: const TextStyle(fontSize: 5, color: _muted, fontStyle: FontStyle.italic)),
                      ])),
                ...
                SizedBox(width: 58, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  for (final s in <(String, double)>[('Figma', 0.95), ('Design Sys.', 0.90), ('Research', 0.85), ('Prototyping', 0.88), ('Sketch', 0.80)])
                    Padding(padding: const EdgeInsets.only(bottom: 5), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(s.$1, style: const TextStyle(fontSize: 5.5, color: _black, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis),
                      const SizedBox(height: 2),
  ...
  Widget _sh(String t) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Text(t, style: const TextStyle(fontSize: 6, fontWeight: FontWeight.w900, color: _black, letterSpacing: 2)),
    const SizedBox(height: 2), Container(width: 16, height: 1.5, color: _black),
    const SizedBox(height: 2), Container(height: 0.4, color: _rule),
  ]);
}

// ─────────────────────────────────────────────────────────────────────────────
// T18 – Collins Classic ATS
// FIX: ClipRect added; header padding 12→8, divider gaps 7→4, summary
// reduced to 1 line with gap 8→5, experience bullet removed and bottom
// padding 7→5, education bottom padding 5→3, footer gap 6→4.
// ─────────────────────────────────────────────────────────────────────────────
class MiniPreview18Collins extends StatelessWidget {
          ...
          child: Container(color: Colors.white,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Center(child: Column(children: [
                const Text('ALEXANDRA CHEN', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w900,
                    color: _ink, letterSpacing: 3)),
                const SizedBox(height: 2),
                const Text('Senior Product Designer', style: TextStyle(fontSize: 5.5, color: _muted, letterSpacing: 1)),
              ...
              const SizedBox(height: 4),
              // Summary
              _sec('PROFESSIONAL SUMMARY'), const SizedBox(height: 3),
              _textLine(double.infinity, _muted.withOpacity(0.4)),
              const SizedBox(height: 5),
              // Experience
              _sec('WORK EXPERIENCE'), const SizedBox(height: 4),
              for (final e in <(String, String, String)>[
                ('Sr. Product Designer', 'Stripe', '2021–Now'),
                ('Product Designer', 'Airbnb', '2018–2021'),
                ('UX Designer', 'IDEO', '2016–2018')])
              ...
              // Education
              _sec('EDUCATION'), const SizedBox(height: 4),
              for (final e in <(String, String, String)>[
                ('BFA Graphic Design', 'RISD', '2016'),
                ('Certificate – HCI', 'Stanford', '2019')])
                Padding(padding: const EdgeInsets.only(bottom: 3), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _sec('SKILLS'), const SizedBox(height: 3),
                  for (final s in ['Figma', 'Design Sys.', 'Research', 'Prototyping'])
                    Padding(padding: const EdgeInsets.only(bottom: 2),
                      child: Text(s, style: const TextStyle(fontSize: 5.5, color: _muted), overflow: TextOverflow.ellipsis)),
                ])),
                const SizedBox(width: 6),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _sec('LANGUAGES'), const SizedBox(height: 3),
                  for (final l in ['English (Native)', 'Mandarin', 'French'])
                    Padding(padding: const EdgeInsets.only(bottom: 2),
                      child: Text(l, style: const TextStyle(fontSize: 5.5, color: _muted), overflow: TextOverflow.ellipsis)),
                ])),
                const SizedBox(width: 6),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _sec('CERTIFICATIONS'), const SizedBox(height: 3),
                  for (final c in ['Google UX Design', 'IDF', 'NN/g UX'])
                    Padding(padding: const EdgeInsets.only(bottom: 2),
                      child: Text(c, style: const TextStyle(fontSize: 5.5, color: _muted), overflow: TextOverflow.ellipsis)),
                ])),
              ]),
            ]),
          ),
  ...
  Widget _sec(String t) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Text(t, style: const TextStyle(fontSize: 5.5, fontWeight: FontWeight.w900, color: _ink, letterSpacing: 2)),
    const SizedBox(height: 2), Container(height: 0.6, color: _rule),
  ]);
}
...
class MiniPreview19Tony extends StatelessWidget {
            ...
            Container(color: _panel,
              ...
              child: Row(children: [
                Stack(children: [
                  ...
                  Positioned(bottom: 0, left: 0, child: Container(width: 10, height: 2.5, color: _orange)),
                ]),
                const SizedBox(width: 8),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Alexandra Chen', style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, color: Colors.white)),
                  const SizedBox(height: 2),
                  Row(children: [Container(width: 10, height: 1.5, color: _orange), const SizedBox(width: 4),
                    const Text('Senior Product Designer', style: TextStyle(color: _orange, fontSize: 5.5, fontWeight: FontWeight.w600)),
                  ]),
                ])),
                ...
                SizedBox(width: 70, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  for (final s in <(String, double)>[('Figma', 0.95), ('Design Sys.', 0.90), ('Research', 0.85), ('Prototyping', 0.88), ('Sketch', 0.80)])
                    Padding(padding: const EdgeInsets.only(bottom: 6), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text(s.$1, style: const TextStyle(color: _muted, fontSize: 5.5), overflow: TextOverflow.ellipsis),
                        Text('${(s.$2 * 100).round()}%', style: const TextStyle(color: _orange, fontSize: 5)),
                      ]),
                      const SizedBox(height: 2.5),
                      Stack(children: [
                        Container(height: 4, decoration: BoxDecoration(color: _divider, borderRadius: BorderRadius.circular(2))),
                        FractionallySizedBox(widthFactor: s.$2, child: Container(height: 4,
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(colors: [Color(0xFFFF9E40), Color(0xFFFF6D00)]),
                  ...
                  for (final l in ['English', 'Mandarin', 'French'])
                    Padding(padding: const EdgeInsets.only(bottom: 3.5), child: Row(children: [
                      ...
                      Expanded(child: Text(l, style: const TextStyle(color: _muted, fontSize: 5), overflow: TextOverflow.ellipsis)),
                    ])),
                ])),
                const SizedBox(width: 10),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  for (final e in <(String, String, String)>[
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 5), child: Container(
                      ...
                      decoration: BoxDecoration(color: _panel, borderRadius: BorderRadius.circular(3),
                          border: const Border(left: BorderSide(color: _orange, width: 2))),
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(e.$1, style: const TextStyle(color: Colors.white, fontSize: 5.5, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis),
                        ...
                        Container(padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 2),
                          decoration: BoxDecoration(color: _orange.withOpacity(0.15), borderRadius: BorderRadius.circular(2)),
                          child: Text(e.$3, style: const TextStyle(color: _orange, fontSize: 5, fontWeight: FontWeight.w700))),
                      ]),
                    )),
                  ...
                  for (final e in <(String, String, String)>[
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 5), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Expanded(child: Text(e.$1, style: const TextStyle(color: Colors.white, fontSize: 6, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)),
                        Container(padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 2),
                          decoration: BoxDecoration(color: _orange.withOpacity(0.15), borderRadius: BorderRadius.circular(2)),
                          child: Text(e.$3, style: const TextStyle(color: _orange, fontSize: 5, fontWeight: FontWeight.w700))),
                      ]),
                      ...
                      const SizedBox(height: 2),
                      Row(children: [const Text(' ·  ', style: TextStyle(color: _orange, fontSize: 5)),
  ...
  Widget _sh(String t, Color c) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Row(children: [Container(width: 2, height: 10, color: c), const SizedBox(width: 4),
      Text(t, style: TextStyle(color: c, fontSize: 5.5, fontWeight: FontWeight.w800, letterSpacing: 1.5))]),
    const SizedBox(height: 2), Container(height: 0.4, color: _divider),
  ]);
}

// ─────────────────────────────────────────────────────────────────────────────
// T20 – Fashion (technical drawing aesthetic — cobalt on white grid)
// FIX: summary reduced to 2 lines; experience text line removed; connector
// bar height 22→16; experience bottom padding 4→3; education bottom padding
// 3→2; education box reduced 20→18px; body padding 8→6.
// ─────────────────────────────────────────────────────────────────────────────
class MiniPreview20Fashion extends StatelessWidget {
        ...
        child: Stack(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                Stack(children: [
                  ...
                  Positioned(top: 0, right: 0, child: Transform.scale(scaleX: -1, child: _miniCorner())),
                  Positioned(bottom: 0, left: 0, child: Transform.scale(scaleY: -1, child: _miniCorner())),
                  Positioned(bottom: 0, right: 0, child: Transform.scale(scaleX: -1, scaleY: -1, child: _miniCorner())),
                ]),
                const SizedBox(width: 8),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(height: 14, color: _grid,
              child: Row(children: [
                ...
                for (final item in [
                  ...
                  Padding(padding: const EdgeInsets.symmetric(horizontal: 5),
                    child: Row(children: [
                      Text('${item.$1}: ', style: const TextStyle(fontSize: 4, color: _muted, fontFamily: 'monospace')),
                      Text(item.$2, style: const TextStyle(fontSize: 4, color: _cobalt, fontFamily: 'monospace', fontWeight: FontWeight.w800)),
                    ])),
              ...
              child: Padding(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(flex: 6, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    _bpSection('SUMMARY'), const SizedBox(height: 3),
                    ...
                    const SizedBox(height: 5),
                    _bpSection('EXPERIENCE'), const SizedBox(height: 3),
                    for (final e in <(String, String, String)>[
                      ('Sr. Product Designer', 'Stripe', '2021–Now'),
                      ('Product Designer', 'Airbnb', '2018–2021'),
                      ('UX Designer', 'IDEO', '2016–2018')])
                      Padding(padding: const EdgeInsets.only(bottom: 3), child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Column(children: [
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(border: Border.all(color: _cobalt), color: _grid),
                                child: Text(e.$3, style: const TextStyle(fontSize: 4, color: _cobalt, fontFamily: 'monospace', fontWeight: FontWeight.w700)),
                              ),
                            ]),
                            Row(children: [
                              Container(width: 6, height: 1, color: _cobaltL),
                              const SizedBox(width: 3),
                              Text(e.$2, style: const TextStyle(fontSize: 5.5, color: _cobaltM, fontWeight: FontWeight.w600)),
                            ]),
                          ]),
                        )),
                      ])),
                    ...
                    for (final e in <(String, String, String)>[
                      ('BFA Graphic Design', 'RISD', '2016'),
                      ('Certificate – HCI', 'Stanford', '2019')])
                      Padding(padding: const EdgeInsets.only(bottom: 2), child: Container(
                        padding: const EdgeInsets.all(4),
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border(
                        ...
                        child: Row(children: [
                          Container(width: 18, height: 18,
                            decoration: BoxDecoration(border: Border.all(color: _cobalt), color: _grid),
                            child: Center(child: Text(e.$3, style: const TextStyle(fontSize: 5, fontWeight: FontWeight.w900, color: _cobalt, fontFamily: 'monospace')))),
                          const SizedBox(width: 4),
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(e.$1, style: const TextStyle(fontSize: 5, fontWeight: FontWeight.w700, color: _ink), overflow: TextOverflow.ellipsis),
                            Text(e.$2, style: const TextStyle(fontSize: 4, color: _muted)),
                          ])),
                        ]),
                      )),
                  ])),
                  ...
                  SizedBox(width: 60, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    for (final s in <(String, double)>[
                      ...
                      Padding(padding: const EdgeInsets.only(bottom: 5), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Expanded(child: Text(s.$1, style: const TextStyle(fontSize: 5, color: _ink, fontFamily: 'monospace'), overflow: TextOverflow.ellipsis)),
                          Text('${(s.$2 * 100).round()}%', style: const TextStyle(fontSize: 4.5, color: _cobaltL, fontFamily: 'monospace', fontWeight: FontWeight.w700)),
                        ]),
                        const SizedBox(height: 2),
                        ClipRRect(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(children: [
                              ...
                              Flexible(
                                ...
                                child: const ColoredBox(color: _grid, child: SizedBox.expand()),
                              ),
                            ]),
                          ),
                        ),
                    ...
                    const SizedBox(height: 4),
                    _bpSection('LANGUAGES'), const SizedBox(height: 3),
                    for (final l in ['English', 'Mandarin', 'French'])
                      Padding(padding: const EdgeInsets.only(bottom: 3), child: Row(children: [
                        Container(width: 5, height: 5, color: _cobalt),
                        const SizedBox(width: 4),
                        Expanded(child: Text(l, style: const TextStyle(fontSize: 5, color: _muted, fontFamily: 'monospace'), overflow: TextOverflow.ellipsis)),
                      ])),
                  ])),
                ]),
              ),
            ...
            Container(height: 12, color: _cobalt,
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                const Text('CURRICULUM VITAE', style: TextStyle(fontSize: 4, color: _cobaltL, fontFamily: 'monospace')),
                const Text('SHEET 1 OF 1', style: TextStyle(fontSize: 4, color: _cobaltL, fontFamily: 'monospace')),
              ])),
          ]),
        ]),
      ),
  ...
  static Widget _bpSection(String t) => Row(children: [
    Container(width: 8, height: 8, color: _cobalt,
      child: Center(child: Text(t.substring(0, 1),
          style: const TextStyle(fontSize: 4.5, fontWeight: FontWeight.w900, color: Colors.white, fontFamily: 'monospace')))),
    const SizedBox(width: 4),
    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(t, style: const TextStyle(fontSize: 5.5, fontWeight: FontWeight.w800, color: _cobalt, letterSpacing: 2, fontFamily: 'monospace')),
...
class _MiniGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()..color = const Color(0xFFDDE6F4)..strokeWidth = 1..style = PaintingStyle.fill;
    const spacing = 12.0;
...
// ─────────────────────────────────────────────────────────────────────────────
// Aliases — registry uses the StepMiniPreviewXX naming convention
// ─────────────────────────────────────────────────────────────────────────────
typedef StepMiniPreview17Canfield = MiniPreview17Canfield;
typedef StepMiniPreview18Collins  = MiniPreview18Collins;
typedef StepMiniPreview19Tony     = MiniPreview19Tony;
typedef StepMiniPreview20Fashion  = MiniPreview20Fashion;