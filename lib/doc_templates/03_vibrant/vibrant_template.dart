                ...
                children: [
                  ...
                  if (a.businessAddress.isNotEmpty)
                    Text(a.businessAddress, style: TextStyle(fontSize: 9,
                        color: Colors.white.withOpacity(0.85), height: 1.4, fontFamily: a.fontFamily)),
                  if (a.businessEmail.isNotEmpty || a.businessPhone.isNotEmpty)
                    Text([a.businessEmail, a.businessPhone].where((s) => s.isNotEmpty).join('   -   '),
                        style: TextStyle(fontSize: 9, color: Colors.white.withOpacity(0.85), fontFamily: a.fontFamily)),
                ],
              ),
            ),
            Column(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('${a.docTypeLabel} #${a.docNumber.isEmpty ? '-' : a.docNumber} ${a.continuationSuffix}',
                style: TextStyle(fontSize: 9.5, color: Colors.white.withOpacity(0.85), fontFamily: a.fontFamily)),
          ],
        ),
      ),
